...
/*
  ...
  http://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=1702402&tag=1
...
;(function($, window)
{
  ...
  var getQueryInfo = function()
  {
     ...
     var num = window.location.href.match(/num=([0-9]+)/);
     num = (num) ? parseInt(offset[1]): 0;  
      
     var q = window.location.href.match(/q=([^&]+)/);
      
      return {offset:offset, num:num, q:q[1]};
  };
